% function for extraction identifiers for screen experiments from a string.
% Input
% single string or cell array of strings, where the string contains the
% cell type, incubation time, concentration and replicate.
% 
% String must be encoded like
% */*[CellType]*[IncubationTime]*_[concentration]nM_[replicate]
% 
% all identifiers may only occur once in the string.

function [CellType, incubation_time, concentration, replicate] = screen_conditionsFromString(input)
...
function [CellType, incubation_time, concentration, replicate] = stringSearch(input)
